...
```
curl -Lo /root/tmp https://github.com/SagerNet/sing-box/releases/download/v1.3.5/sing-box-1.3.5-linux-amd64.tar.gz && tar -xzf /root/tmp && cp -f /root/sing-box-*/sing-box /root && rm -r /root/tmp /root/sing-box-* && chown root:root /root/sing-box && chmod +x /root/sing-box && mv -f /root/sing-box /usr/local/bin
```
